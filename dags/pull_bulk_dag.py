...
TABLES = [
    ...
    "AAFBNK_AA010",
    "FBNK_AA_ARR_ACCOUNT",
    "FBNK_AA_BILL_DETAILS",
    "FBNK_CUSTOMER",
    "FBNK_AA_ACCOUNT_DETAILS",
    "FBNK_PV_ASSET_DETAIL",
    "FBNK_ACCOUNT_STATEMENT",
    "FBNK_AA_ARRANGEMENT",
    "AAFBNK_AA063",
    "FBNK_AC_LOCKED_EVENTS",
    "FBNK_FUNDS_TRANSFER",
    ...
    "ACFBNK_AC009",
    "AAFBNK_AA093",
    "FBNK_CUSTOMER_ACCOUNT",
    "FBNK_STMT_PRINTED",
    "FBNK_AA_ARR_CUSTOMER",
    "FBNK_AA_ARR_TERM_AMOUNT",
    "FBNK_ACCOUNT_CLOSED",
    "FBNK_ACCT_STMT_PRINT",
    "FBNK_EM_LO_APPLICATION",
    "F_AA_CUSTOMER_ROLE",
    "FBNK_AC_SUB_ACCOUNT",
    "FBNK_TELLER",
    "FBNK_ACCT_ENT_TODAY",
    "FBNK_EM_DL_APPLICATION",
    "FBNK_ACCOUNT_HIS",
]
...
def _wait_cob(**ctx) -> bool:
    ...
    if not forced:
        ...
        d, _ = res
    pg = ctl.hook(CONN_ID)
    if not forced and ctl.all_sealed(pg, d, TEST_TABLES):
        return False
    ...
    for name in TABLES:
        ...
        extract = KubernetesPodOperator(
            ...
            arguments=[
                ...
                "--table",    f"dbo.{name}",
                "--output",   f"s3a://raw/test_bulk/{name}/"
        ...
        parse = SparkKubernetesOperator(
            ...
            namespace=SPARK_NS,
            application_file="t24_bulk_parse.yaml",
